...
namespace Nop.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        public virtual IActionResult Completed(int? orderId, string paymentmethodValue = "")
        {
            ...
            //////
            var code = paymentmethodValue;//form["paymentmethodValue"].ToString();
    ...
    //            {"ipn_url",storeLocation+"Admin/Order/IpnBack?orderId="+order.Id }
            //};
                ...
                return RedirectToAction("Crypto", new {  orderId = order.Id });
                //var Webget = new HtmlWeb();
                //var doc = Webget.Load(url);
                //HtmlNode node = doc.QuerySelector("div.container");
                //ViewBag.html = node.OuterHtml;
            }
        ...
        public virtual IActionResult OpcSavePaymentInfo(IFormCollection form)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    ViewBag.paymentmethodValue = form["paymentmethodValue"].ToString();////
